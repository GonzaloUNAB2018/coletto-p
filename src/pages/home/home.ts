...
import { NavController, App, MenuController, ToastController, Nav, AlertController, Platform, LoadingController } from 'ionic-angular';
...
export class HomePage {
  ...
  //@ViewChild('map') mapElement: ElementRef; //nav: Nav;
  //mapNative: GoogleMap;
  map: any;
  //icon: any = null;
  uid : any = null;
  ...
  buttonOpen: boolean;
  circle: { center: { lat: number; lng: number; }; location: number; };
  cityCircle : any;
...
//  #####  MAPA NATIVE  #####  //
    ...
    this.mapNative = GoogleMaps.create('map', mapOptions);

    this.mapNative.addMarker({
